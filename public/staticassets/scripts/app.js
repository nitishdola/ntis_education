...
var App = function () {
    ...
    var handleInit = function() {
     ...
     var handlNumericTextBox = function () {
        if (jQuery().ForceNumericOnly) {
            $(".numbertextbox").ForceNumericOnly();
        }
    }

    var handleNumberFormatingTextBox = function () {
        if (jQuery().number) {
            $('.number-formatextbox').number(true, 0);
        }
    }
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
                message: '<img src="../assets/admin/img/ajax-loading.gif" />',
