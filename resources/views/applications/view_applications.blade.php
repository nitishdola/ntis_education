...
@endif
	<div class="col-md-12">
		...
		<tr id="cert_{{$r->id}}">
			...
			<td>
				{{ date('d-m-Y', strtotime($r->apply_date)) }}
			</td>
			<td>
				 <a href="{{route('application.view', $r->id)}}"><i class="fa fa-pencil-square-o"></i>Accept</a> 
				 | <a href="{{route('application.reject', $r->id)}}"><i class="fa fa-pencil-square-o"></i>Reject</a> 
			</td>
