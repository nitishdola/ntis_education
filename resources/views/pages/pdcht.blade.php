...
<div class="container courses-page">
	...
	<div class="row course-syll">
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<h4><i class="fa fa-check-circle"></i> Fuctions of Mother Board, PCI Card, Sound Card, Storage Devices</h4>
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<h4><i class="fa fa-check-circle"></i> Hardware and Software Marketing</h4>
		</div>
