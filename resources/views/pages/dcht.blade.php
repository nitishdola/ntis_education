...
<div class="container courses-page">
	...
	<div class="row course-syll">
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<h4><i class="fa fa-check-circle"></i> PC Troubleshooting</h4>
			<h4><i class="fa fa-check-circle"></i> BIOS Settings</h4>
			<h4><i class="fa fa-check-circle"></i> Partitioning and Formatting of Hardisk</h4>
			<h4><i class="fa fa-check-circle"></i> Installation of Operating Systems</h4>
			<h4><i class="fa fa-check-circle"></i> Installation of various Application Software</h4>
